...
('Patrícia Daiane Alice Duarte', '753.557.845-42', 'patricia', sha1('123')),
('Pedro Erick Nicolas Dias', '171.224.293-85', 'pedro', sha1('123')),
('Luzia Marcela Martins', '700.106.748-29', 'luzia', sha1('123')),
('Antonio Nathan Jesus', '211.704.977-05', 'antonio', sha1('123')),
('Miguel Bryan dos Santos', '189.647.320-22', 'miguel', sha1('123')),
('Heloise Julia Clarice Farias', '069.083.126-90', 'heloise', sha1('123'));
