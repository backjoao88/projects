...
CREATE TABLE IF NOT EXISTS `vendaSimples`.`produto` (
  ...
  `estoque` INT NULL,
  `codigodebarra` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_produto_marca1`
    ...
    REFERENCES `vendaSimples`.`marca` (`idmarca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `vendaSimples`.`venda` (
  ...
  CONSTRAINT `fk_venda_cliente`
    ...
    REFERENCES `vendaSimples`.`cliente` (`idcliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_venda_vendedor1`
    FOREIGN KEY (`vendedor_idvendedor`)
    REFERENCES `vendaSimples`.`vendedor` (`idvendedor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `vendaSimples`.`produto_has_venda` (
  ...
  CONSTRAINT `fk_produto_has_venda_produto1`
    ...
    REFERENCES `vendaSimples`.`produto` (`idproduto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_produto_has_venda_venda1`
    FOREIGN KEY (`venda_idvenda`)
    REFERENCES `vendaSimples`.`venda` (`idvenda`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
