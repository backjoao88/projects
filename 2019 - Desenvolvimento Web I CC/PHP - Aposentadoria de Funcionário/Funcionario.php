<?php
    ...
    class Funcionario extends Usuario{
        ...
        public function __construct($login, $senha, $nome, $email, $dataNascimento){
        ...
        public function mediaTodosSalarios(){
                ...
                for ($i = 0; $i < $this->numeroMesesTrabalhados(); $i++){
                        $salarios[$i] = calcularSalarioMes($i)
                }
        ...
        public function numeroAnosTrabalhados(){
                return $this->numeroMesesTrabalhados()/12;
        }
        ...
        public function menoresSalariosAte($n){
                ...
                $salarios = array_sort($salarios);
                for ($i = $this->numeroMesesTrabalhados(); $i >= $n; $i--){
                        $maioresSalarios[$i] = $salarios[$i];
                }
                return $maioresSalarios;
        }
